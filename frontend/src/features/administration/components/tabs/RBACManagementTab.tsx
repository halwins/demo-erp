    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-[24px] font-bold text-[#242424]">Role Management</h2>
            <p className="text-[14px] text-[#898989] mt-1">
              {filteredRoles.length} roles in this organization
            </p>
          </div>
          <Button
            onClick={() => {
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-[#f8f8f8] border-b border-[#e0e0e0]">
                  <TableHead className="font-semibold text-[13px] text-[#242424]">Role Name</TableHead>
                  <TableHead className="font-semibold text-[13px] text-[#242424]">Permissions Count</TableHead>
                  ...
                  <TableRow>
                    <TableCell colSpan={4} className="text-center py-12">
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-[14px] text-[#898989]">No roles found</p>
                        <Button
                          variant="link"
      ...
      {selectedRole && (
        <div className="space-y-6 pt-8 border-t border-[#e0e0e0]">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-[24px] font-bold text-[#242424]">Permission Matrix</h3>
              <p className="text-[14px] text-[#898989] mt-1">
                Role: <span className="font-semibold text-[#242424]">{selectedRole.name}</span>
              </p>
            </div>
            <Button
              variant="outline"
